...
export class EtherService {
  ...
  ABI_DAO = [
    {
      inputs: [
        ...
        { internalType: "uint8", name: "nftPerUser_", type: "uint8" },
        { internalType: "uint16", name: "nftThreshold_", type: "uint16" },
        { internalType: "address", name: "whitelist1", type: "address" },
        { internalType: "address", name: "whitelist2", type: "address" },
    ...
    {
      inputs: [{ internalType: "uint8", name: "nftPerUser_", type: "uint8" }],
      name: "setNftPerUser",
      outputs: [],
      stateMutability: "nonpayable",
      type: "function",
    ...
    {
      inputs: [{ internalType: "uint16", name: "_threshold", type: "uint16" }],
      name: "setNftThreshold",
      outputs: [],
      stateMutability: "nonpayable",
      type: "function",
    },
  ...
  ABI_STAKE = [
    ...
    {
      inputs: [
        { internalType: "address", name: "checkProxy", type: "address" },
      ],
      name: "isProxy",
      outputs: [{ internalType: "bool", name: "", type: "bool" }],
      stateMutability: "view",
    ...
    {
      inputs: [{ internalType: "address", name: "badProxy", type: "address" }],
      name: "revokeProxy",
      outputs: [],
      stateMutability: "nonpayable",
      type: "function",
    ...
    {
      inputs: [
        { internalType: "uint256", name: "newCoinsPerDay", type: "uint256" },
      ],
      name: "setCoinsPerDay",
      outputs: [],
      stateMutability: "nonpayable",
    ...
    {
      inputs: [{ internalType: "uint256", name: "newCycle", type: "uint256" }],
      name: "setCycleLengthinDays",
      outputs: [],
      stateMutability: "nonpayable",
      type: "function",
    },
    {
      inputs: [
        { internalType: "uint256", name: "newHoldTime", type: "uint256" },
      ],
      name: "setHoldTimeinDays",
      outputs: [],
      stateMutability: "nonpayable",
      type: "function",
    },
  ...
  async stakeNFT(tokenIds) {
    console.log('stakeNFT')
    const contract = await this.getStakingContract();
    const nftObj = contract.methods.stakeMany(tokenIds).encodeABI();
  ...
  async unstakeAll() {
    ...
    if (wallet) {
      let STAKEcon = new web3.eth.Contract(this.ABI_STAKE, this.STAKE);
      const unstake = await STAKEcon.methods
        .unstakeAll()
